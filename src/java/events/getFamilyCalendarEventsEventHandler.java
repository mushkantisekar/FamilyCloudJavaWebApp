    ...
    public JSONArray toJSONEventsList(List<FamCalEvent> events, boolean adult) {
        ...
        for (int i = 0; i < events.size(); i++) {
            ...
            if (((temp.getVisibility().equals("Adults")) && adult == true) || temp.getVisibility().equals("All")) {
                ...
                if (temp.getCategory().equals("green")) {
                    eventJSON.put("color", "#2ECC71");
                    eventJSON.put("textColor", "white");
                } else if (temp.getCategory().equals("red")) {
                    eventJSON.put("color", "#E74C3C");
                    eventJSON.put("textColor", "white");
                } else if (temp.getCategory().equals("purple")) {
                    eventJSON.put("color", "#BF55EC");
                    eventJSON.put("textColor", "white");
                } else if (temp.getCategory().equals("blue")) {
                    eventJSON.put("color", "#4183D7");
                    eventJSON.put("textColor", "white");
                }
