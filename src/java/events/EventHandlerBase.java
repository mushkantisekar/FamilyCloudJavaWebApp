...
public abstract class EventHandlerBase {
    ...
    public void process(HttpSession sc,HttpServletRequest request, HttpServletResponse
        response)
    ...
    //The forward() method passes control to a JSP file to generate the response:
