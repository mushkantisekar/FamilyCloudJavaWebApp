...
//to get states
        ...
        <script>
            ...
            function checkPassword(password) {
               ...
               var xmlHttp = GetXmlHttpObject();
                ...
                else
                {
                    ...
                    xmlHttp.onreadystatechange = function(){password_return(xmlHttp)};
            ...
            function password_return(xmlHttp) {
                ...
                <div class="collapse navbar-collapse" id="myNavbar1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation">
                            <a href="controller_servl?event=HELPEVE&tag=false"><img class="img-responsive" src="img/help.png" width="20" height="20" ></a>
                           </li>
                    </ul>
                </div>
                        ...
                        <div class="col-sm-2 col-xs-4 sidebar-offcanvas" id="sidebarleft" role="navigation">
                            <div class="sidebar-nav">
                                <ul class="nav nav-pills nav-stacked ">
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getMyFamily()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/my_family.png"></span>My Family</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getWallPost()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/family_wall.png"></span>Family Wall</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getFamilyCalendar()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/Calendar.png"></span>Family Calendar</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getPersonalCalendar()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/Calendar.png"></span>My Calendar</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getMealsPlan()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/Meals.png"></span>Meals Plan</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getShoppingList()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/Shopping.png"></span>Shopping List</a>
                                    </li>
                                    <li role="presentation" style="cursor: pointer;"><a onclick="getToDoList()"><span class="family-icon" aria-hidden="true"><img alt="Notifications" width="60" height="60" src="img/Todo_list.png"></span>To Do List</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
