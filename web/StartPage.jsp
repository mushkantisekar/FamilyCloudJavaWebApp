...
//to get states
            function getDuplicateUsername(username)
            {
              ...
              var  xmlHttp = GetXmlHttpObject();
                ...
                else
                {
                    ...
                    xmlHttp.onreadystatechange = function(){usernameReturn(xmlHttp)};
            ...
            function usernameReturn(xmlHttp)
            {
            ...
            function getDuplicateEmails(registeremail)
            {
              ...
              var  xmlHttp = GetXmlHttpObject();
                ...
                else
                {
                    ...
                    //creating callback method.here countrychanged is callback method
                    xmlHttp.onreadystatechange = function(){emailReturn(xmlHttp)};
    ...
    <body>
        ...
        <div class="fullcont">
            ...
            <div class="container">
                ...
                <p class="headerp">Family cloud not what you want ...but what you need</p>
        ...
        <div class="modal fade" id="loginmodal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="login_form" class="form-horizontal" accept-charset="UTF-8" action="controller_servl" method="post">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input type="password" class="form-control" id="login-password" placeholder="Password" name="password_n" required>
