...
function getToDoList() {
   ...
   var xmlHttp = GetXmlHttpObjectTODO();
    if (xmlHttp == null)
    {
    ...
    else
    {
        ...
        xmlHttp.onreadystatechange =function(){ todolist_return(xmlHttp)};
...
function todolist_return(xmlHttp)
{
...
function editToDoItem(itemID) {
   var xmlHttp = GetXmlHttpObjectTODO();
    ...
    else
    {
        ...
        xmlHttp.onreadystatechange = function(){edit_details_return(xmlHttp)};
...
function edit_details_return(xmlHttp)
{
...
function deleteToDoItem(itemID) {
    ...
    else
    {
        ...
        xmlHttp.onreadystatechange = function(){delete_details_return(xmlHttp)};
...
function delete_details_return(xmlHttp)
{
...
function sorttableshop(sortedTable) {
   ...
   var xmlHttp = GetXmlHttpObjectTODO();
    ...
    else
    {
        ...
        xmlHttp.onreadystatechange = function(){sortedfuncTable(xmlHttp)};
...
function sortedfuncTable(xmlHttp) {
