                ...
                <div id="collapsepost" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                    <form id="formpost" name="formpost"  enctype="multipart/form-data" >
                        <div class="panel-body">
                            ...
                            <input id="file-id" type="file" accept="image/*" name="our-file" />
                            ...
                            <div class=""> 
                                <div class="btn-toolbar pull-right">
                                    <div class="btn-group ">
                                        <button type="button" class="btn btn-default" id="closepost" data-toggle="collapse" data-parent="#accordion" href="#collapsepost">Close</button>
                                    </div>
                                    <div class="btn-group">
