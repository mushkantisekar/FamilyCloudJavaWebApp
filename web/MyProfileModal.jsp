            ...
            <form id="myprofile_form">
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input class="form-control" type="password" id="oldpass" oninput="checkPassword(this.value)" placeholder="Old Password" pattern="(?=^.{6,}$)((?=.*[A-Z])|(?=.*[a-z])|(?=.*[0-9])).*$" required/><span id="passspan">Invalid input</span>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input class="form-control" type="password" id="newpass" oninput="style_inp('newpass')" placeholder="New Password" pattern="(?=^.{6,}$)((?=.*[A-Z])|(?=.*[a-z])|(?=.*[0-9])).*$" required/><span>Invalid input</span>
                    </div>
                    <div class="col-sm-6">
                        <label for="retypenewpass">Retype Password</label>
                        <input class="form-control" type="password" id="retypenewpass" oninput="style_inp('retypenewpass')" placeholder="Retype Password" pattern="(?=^.{6,}$)((?=.*[A-Z])|(?=.*[a-z])|(?=.*[0-9])).*$" required/><span id="retpassw">Invalid input</span>
                    </div>
                </div>
            </form>
        </div>
