    ...
    <div class="col-sm-12" id="contentcontent">					
            ...
            <div class="btn-toolbar" role="toolbar" id="shoppinglisttbuttonbar"> 
                ...
                <div class="btn-group pull-right" role="group">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu" id="sortShopMob_list">

                            <li><a onclick="sorttableshopSHOP('title')">Title</a></li>
                            <li><a onclick="sorttableshopSHOP('assigned_to')">Assigned To</a></li>
                            <li><a onclick="sorttableshopSHOP('created_by')">Created By</a></li>
                            <li><a onclick="sorttableshopSHOP('quantity')">Quantity</a></li>
                            <li><a onclick="sorttableshopSHOP('price')">Price</a></li>
                            <li><a onclick="sorttableshopSHOP('status')">Status</a></li>
        ...
        <div class="row">
            ...
            <div id="no-more-tables" class="perivlimatable2">
                ...
                <table class="col-md-12 table-bordered table-striped table-condensed cf" id="shoplisttable">
                    <thead>
                        <tr>
                            <th>#</th>
                    ...
                    <c:forEach items="${familyShopList}" var="familyShopList" varStatus="loopStatus">
                        <tr>
                            ...
                            <td data-title="Title">${familyShopList.shoptitle}</td>
                            <td data-title="Assigned To">${familyShopList.assigned_to}</td>
                            <td data-title="Created By">${familyShopList.created_by}</td>
                            <td data-title="Quantity">${familyShopList.quantity}</td>
                            <td data-title="Price">${familyShopList.price}</td>                                    
                            <td data-title="Status">${familyShopList.shopstatus}</td>
