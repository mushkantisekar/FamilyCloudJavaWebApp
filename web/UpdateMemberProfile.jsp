    ...
    <div class="col-sm-8">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <input type="text" class="form-control" id="emaileditmember" oninput="style_inp('emaileditmember')" name="email" placeholder="Email" value="${json.selected_user.email}"  pattern="^[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required><span>Invalid mail input</span>
            </div>
            <div class="col-sm-6">
