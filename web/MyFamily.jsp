...
<div class="col-sm-8 col-xs-12 " id="maincontent">
    ...
    <div class="col-sm-12" id="contentcontent">
            ...
            <div class="col-sm-4 col-md-3 col-xs-4">
                <div class="thumbnail family_director">
                    ...
                    <div class="caption">
                        ...
                        <button style="${json.hidden}" class="btn btn-default btn-sm" role="button" data-toggle="modal" data-target="#editfamilydirector"><span class="glyphicon glyphicon-pencil" > Edit</span></button>
                        <button class="btn btn-default btn-sm" role="button" data-toggle="modal" data-target="#viewfamilydirector"><span class="glyphicon glyphicon-eye-open"> View</span></button>
        ...
        <c:choose>
            <c:when test="${json.cur_user.director eq 'Y'}">
                <div class="row">
                    <div class="col-sm-12">
        ...
        <ul class="nav" id="membersnavigation">
                ...
                <li>
                    <div class="col-sm-4 col-md-3 col-xs-4">
                        <div class="thumbnail family_members">
                            <img class="img-rounded" role="img" id="img${family_list.username}" src="controller_servl?event=GETPIC&username=${family_list.username}&time=<%=System.currentTimeMillis()%>">
                            <div class="caption">
            ...
            <c:choose>
                <c:when test="${emptya eq '1'}">
                    <li>
                    <img alt="photo" class="img-responsive" src="img/emptyMembers.png"/>
                    </li>
                </c:when>
            </c:choose>
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <input type="email" class="form-control" id="emailaddmember" placeholder="Email" oninput="getDuplicateEmailsMyFam(this.value)"><div id="famemailret"></div>
                            </div>
                            <div class="col-sm-6">
