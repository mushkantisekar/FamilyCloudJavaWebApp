            ...
            <div class="row">
                <div class="col-sm-6">
                    <label for="datepickeraddeventpersonal">Event Range *</label>
                        ...
                        <input type="datetime" class="input-sm form-control" name="start" id="datepickerediteventpersonalstart" oninput="style_inp('datepickerediteventpersonalstart')" name="datepickerediteventpersonalstart" placeholder="YYYY-MM-DD HH:MM:SS" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${handleevent.start_date}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid datetime input</span>
                        <input type="datetime" class="input-sm form-control" name="end" id="datepickerediteventpersonalend" oninput="style_inp('datepickerediteventpersonalend')" name="datepickerediteventpersonalend" placeholder="YYYY-MM-DD HH:MM:SS" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${handleevent.end_date}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid datetime input</span>
            ...
            <div class="repeat" id="editpersonalrepeat" style="display:none">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="datetime" class="form-control" id="editpersonalexpiresat" oninput="style_inp('editpersonalexpiresat')" name="editpersonalexpiresat" placeholder="YYYY-MM-DD HH:MM:SS" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${handleevent.endRepeatDate}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid datetime input</span>
                    </div>
                </div>
            </div>
        </div>
