...
<div class="modal-content" id="modal-content">
    ...
    <form id="editeventfamilyform" name="editevfamform">
        <div class="modal-body">
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="text" class="form-control" id="editfamilyevent_title" oninput="style_inp('editfamilyevent_title')"  name="editfamilyevent_title" placeholder="Enter Title" value="${event.title}" required><span>You have to enter a title</span>
                </div>
                <div class="col-sm-6">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <input type="datetime" class="input-sm form-control" placeholder="YYYY-MM-DD HH:MM:SS"  id="datepickerediteventfamilystart" oninput="style_inp('datepickerediteventfamilystart')" name="datepickerediteventfamilystart" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${event.start_date}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>

                    <input type="datetime" class="input-sm form-control" placeholder="YYYY-MM-DD HH:MM:SS"  id="datepickerediteventfamilyend" oninput="style_inp('datepickerediteventfamilyend')" name="datepickerediteventfamilyend" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${event.end_date}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="radio" id="editfamilyevent_visibility">
                        <label>
                            <input type="radio" name="optradio5" value="Adults" ${visibility.adults}>Adults
                        </label>
                    </div>
                    <div class="radio">
                        <label>
                            <input type="radio" name="optradio5" value="All" ${visibility.all}>All members
                        </label>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <div class="input-group" role="group" id="editfamilyevent_notification">
                        <input type="number" class="form-control input-sm" id="editfamilyevent_notification_time" oninput="style_inp('editfamilyevent_notification_time')"  name="editfamilyevent_notification_time" placeholder="0" value="${event.notificationTime}" min="0" required>
            ...
            <div class="repeat" id="editfamilyrepeat" style="display:none">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <input type="datetime" class="form-control" id="editfamilyrepeatstart" oninput="style_inp('editfamilyrepeatstart')"  name="editfamilyrepeatstart" placeholder="YYYY-MM-DD HH:MM:SS" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${event.startRepeatDate}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        ...
                        <input type="number" class="form-control input-mir" id="editfamilyrepeatevery" oninput="style_inp('editfamilyrepeatevery')" name="editfamilyrepeatevery" placeholder="0" value="${event.repeat_every}" min="1" required><span>Invalid number input</span>
                        <!--- prepei na prosthesw days/ months/ weeks analoga me tin proigoumeni epilogi ---->
                    </div>
                    <div class="col-sm-6">
                        <label>Expiration: *</label>
                        <input type="datetime" class="form-control" id="editfamilyexpiresat" oninput="style_inp('editfamilyexpiresat')" name="editfamilyexpiresat" placeholder="YYYY-MM-DD HH:MM:SS" value="<fmt:formatDate pattern='yyyy-MM-dd HH:mm:SS' value='${event.endRepeatDate}' />" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31)) (0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" required/><span>Invalid Datetime input</span>
                        <span class="input-group-editon">to</span>
                    </div>
                </div>
            </div>
        ...
        <div class="modal-footer">
            <div id="suc_todo_mes_valid_Fed" style="font-size:120% ; width:100%;text-align:left"></div>
